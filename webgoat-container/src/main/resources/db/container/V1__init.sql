...
CREATE TABLE IF NOT EXISTS CONTAINER.ASSIGNMENT (
  ID BIGINT NOT NULL PRIMARY KEY,
  NAME VARCHAR(255),
  PATH VARCHAR(255)
);

CREATE TABLE IF NOT EXISTS CONTAINER.LESSON_TRACKER(
  ID BIGINT NOT NULL PRIMARY KEY,
  LESSON_NAME VARCHAR(255),
  NUMBER_OF_ATTEMPTS INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS CONTAINER.LESSON_TRACKER_ALL_ASSIGNMENTS(
...
CREATE TABLE IF NOT EXISTS CONTAINER.LESSON_TRACKER_SOLVED_ASSIGNMENTS(
  LESSON_TRACKER_ID BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CONTAINER.USER_TRACKER(
  ID BIGINT NOT NULL PRIMARY KEY,
  USERNAME VARCHAR(255)
);

CREATE TABLE IF NOT EXISTS CONTAINER.USER_TRACKER_LESSON_TRACKERS(
...
CREATE TABLE IF NOT EXISTS CONTAINER.WEB_GOAT_USER(
  USERNAME VARCHAR(255) NOT NULL PRIMARY KEY,
  PASSWORD VARCHAR(255),
  ROLE VARCHAR(255)
);

CREATE TABLE IF NOT EXISTS CONTAINER.EMAIL(
